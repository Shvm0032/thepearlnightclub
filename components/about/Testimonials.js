  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-6 relative">
        ...
        >
          <h4 className="text-gray-500 tracking-widest mb-2">
            TESTIMONIALS
          </h4>
        ...
        {/* Custom Nav Buttons (center aligned) */}
        <button
          className="swiper-button-prev-custom absolute left-0 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full bg-white/80 shadow border hover:bg-white transition z-30 text-[#D05A50]"
        >
          <ChevronLeft size={22} />
        </button>

        <button
          className="swiper-button-next-custom absolute right-0 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full bg-white/80 shadow border hover:bg-white transition z-30 text-[#D05A50]"
        >
