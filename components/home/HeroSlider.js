  ...
  return (
    <div className="relative w-full h-screen  overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-20 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4 z-20"
      >
        <div className="flex flex-col md:flex-row gap-4 bg-white/10 backdrop-blur p-4 rounded-lg border border-orange-500/30">
          <input
            type="text"
            placeholder="Enter name..."
            className="flex-1 px-4 py-3 bg-white/80 rounded text-gray-900 placeholder-gray-500 focus:outline-none"
          />
          <select className="flex-1 px-4 py-3 bg-white/80 rounded text-gray-900 focus:outline-none">
